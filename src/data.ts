export const data = [
  {
    id: 1,
    date: '2020-01-01',
    title: "New Year live in concer'22",
    description:
  ...
  },
  {
    id: 2,
    date: '2020-07-14',
    title: 'Xperience praise fiesta with limoblaise',
    description:
      'Xperience praise is a praise concert that brings together people from all walks of life to praise God.',
    coverPicture:
  ...
  },
  {
    id: 3,
    date: '2020-08-01',
    title: 'The 2020 edition of the Lagos Jazz Festival',
    description:
      'The Lagos Jazz Festival is an annual music festival that takes place in Lagos, Nigeria.',
